...
def generate_acceptable_scopes(
    ...
    for action in endpoint_actions:
        ...
        acceptable_sensitivities = _get_acceptable_sensitivity_values(domain, sensitivity)
...
def _get_acceptable_sensitivity_values(domain: str, sensitivity: SensitivityLevel) -> List[str]:
